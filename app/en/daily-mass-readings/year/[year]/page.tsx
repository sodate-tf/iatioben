...
//
// English year hub (parallel to PT, does NOT change PT indexed URLs).
// - Uses “Daily Mass Readings” as the culturally standard term.
// - Keeps strong internal linking (prev/next year + months grid + crawlable list).
// - Uses English month labels for UX while maintaining your existing month routing pattern.
...
export default async function DailyMassReadingsYearPage({
  ...
  // Internal linking cluster: previous/next year
