...
`;
    ...
    const response = await fetch("https://gemini.googleapis.com/v1beta/{model=models/*}:generateContent", {
      method: "POST",
      headers: {
    ...
    const resposta = data.text || "Desculpe, não consegui obter resposta do Tio Ben.";
